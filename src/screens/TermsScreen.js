    ...
    <ScrollView>
      <View style={{height: '100%', width: '100%', backgroundColor: '#222222'}}>
        ...
        <Text
          ...
          before before using the app. You’re not allowed to copy, or modify the
          app, any part of the app, or our trademarks in any way. You’re not
          ...
          related to it, still belong to Destra. Destra is committed to ensuring
          that the app is as useful and efficient as possible. For that reason,
          ...
          what you’re paying for. The Destra app stores and processes personal
          data that you have provided to us, in order to provide my Service.
          ...
          that the Destra app won’t work properly or at all. The app does use
        ...
        <Text
          style={styles.Text}>
          You should be aware that there are certain things that Destra will not
          ...
          Wi-Fi, or provided by your mobile network provider, but Destra cannot
          ...
          from the bill payer for using the app. Along the same lines, Destra
          ...
          battery and you can’t turn it on to avail the Service, Destra cannot
          accept responsibility. With respect to Destra’s responsibility for
          your use of the app, when you’re using the app, it’s important to bear
          in mind that although we endeavour to ensure that it is updated and
          correct at all times, we do rely on third parties to provide
          information to us so that we can make it available to you. Destra
          ...
          keep using the app. Destra does not promise that it will always update
        ...
        <Text   style={styles.Text} >I may update our Terms and Conditions from time to time. Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new Terms and Conditions on this page.
These terms and conditions are effective as of 2021-10-01
</Text>
      </View>
    </ScrollView>
  );
